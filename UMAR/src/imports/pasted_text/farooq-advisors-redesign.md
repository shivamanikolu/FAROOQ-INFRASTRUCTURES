FAROOQ ADVISORS — COMPLETE LUXURY EDITORIAL WEBSITE REDESIGN
ROLE
...
Creative Director
Financial Brand Designer
Information Architect
UX Strategist
Typography Specialist

Your task is to redesign the complete website experience while preserving all business information.

MANDATORY INSTRUCTION

I have already provided a complete design system.

The design system is attached below as:
...
This design system is the ONLY source of truth.

STRICT RULES
Read the complete design system first.
Follow the design system exactly.
Do not modify colors.
Do not modify typography.
Do not modify spacing philosophy.
Do not modify layout philosophy.
Do not modify motion philosophy.
Do not modify component philosophy.
Do not invent new styles.
Do not use AI-builder default designs.
Do not use generic SaaS layouts.
Do not use startup landing page patterns.
Do not use dashboard-inspired sections.
Do not replace the provided visual language.
Every design decision must follow the provided design system.

If there is a conflict between your own design decisions and the provided design system, always follow the design system.

EXISTING BUSINESS INFORMATION TO PRESERVE
Brand
...
Farooq Infrastructures Pvt Ltd
...
Piduguralla, Palnadu District, Andhra Pradesh

Contact Information

Email:

farooqinfrastructures@gmail.com
shaikumarfarooq5541@gmail.com
...
Nothing should be lost during redesign.

NEW INFORMATION ARCHITECTURE
1. Editorial Hero Section

Create a world-class editorial hero.
...
Founder-first branding
Sophisticated CTA placement
Editorial composition
Visible grid structure
Luxury storytelling
2. Founder Authority Section

This should become the strongest section on the website.

Requirements:

Large premium founder portrait placeholder
Editorial layout
Founder story
...
Image must be placeholder only.

I will replace it later.

3. About Founder Story

Create an editorial storytelling section explaining:

Who Umar Farooq Shaik is
Why he teaches
His mission
His educational philosophy

Use luxury magazine-style layouts.

4. About Company

Present Farooq Advisors and Farooq Infrastructures Pvt Ltd as a trusted educational and advisory brand.
...
Transform this into a luxury trust-building section.
...
Use premium editorial feature layouts.

Not generic cards.

7. Learning Curriculum Section
...
Present as a premium educational journey.

8. Learning Roadmap Section

Create a visual learning journey.

Show progression from beginner to confident market participant.

Maintain all curriculum information.
...
Present using luxury editorial typography.

10. Testimonials Section

Create premium testimonial experiences.
...
Preserve all existing team members exactly.

Do not remove any team members.

Do not rename any team members.

Do not generate fake team members.

Do not generate placeholder names.

Display the following team members:
...
Use a luxury editorial team layout.
...
The team section should feel premium, credible, and professional while remaining minimal and elegant.

Use the provided design system exactly.
...
Present as trust-building elements.
...
Preserve all footer information.
...
Use one premium founder image placeholder

Everything else:

No team image placeholders
No fake profile photos
No unnecessary stock images

Use imagery only where it strengthens the editorial experience.
...
Premium Financial Education Brand
Boutique Investment Consultancy
High-End Advisory Firm

It must NOT look like:

AI Generated
Generic Figma Template
SaaS Landing Page
Bootstrap Website
Startup Marketing Page
Dashboard Product

Create a handcrafted luxury editorial experience while preserving all business information and following the attached design system exactly.